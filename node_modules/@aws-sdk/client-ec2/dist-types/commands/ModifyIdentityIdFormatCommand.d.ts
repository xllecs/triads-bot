...
declare const ModifyIdentityIdFormatCommand_base: {
    new (input: ModifyIdentityIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIdentityIdFormatCommandInput, ModifyIdentityIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyIdentityIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIdentityIdFormatCommandInput, ModifyIdentityIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
