...
declare const ModifyIpamResourceDiscoveryCommand_base: {
    new (input: ModifyIpamResourceDiscoveryCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIpamResourceDiscoveryCommandInput, ModifyIpamResourceDiscoveryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyIpamResourceDiscoveryCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIpamResourceDiscoveryCommandInput, ModifyIpamResourceDiscoveryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
