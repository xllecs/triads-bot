...
declare const DeleteTransitGatewayRouteTableCommand_base: {
    new (input: DeleteTransitGatewayRouteTableCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransitGatewayRouteTableCommandInput, DeleteTransitGatewayRouteTableCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteTransitGatewayRouteTableCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransitGatewayRouteTableCommandInput, DeleteTransitGatewayRouteTableCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
