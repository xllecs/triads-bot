...
declare const DeprovisionIpamByoasnCommand_base: {
    new (input: DeprovisionIpamByoasnCommandInput): import("@smithy/smithy-client").CommandImpl<DeprovisionIpamByoasnCommandInput, DeprovisionIpamByoasnCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeprovisionIpamByoasnCommandInput): import("@smithy/smithy-client").CommandImpl<DeprovisionIpamByoasnCommandInput, DeprovisionIpamByoasnCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
