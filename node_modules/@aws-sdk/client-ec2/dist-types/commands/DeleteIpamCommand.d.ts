...
declare const DeleteIpamCommand_base: {
    new (input: DeleteIpamCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamCommandInput, DeleteIpamCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteIpamCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamCommandInput, DeleteIpamCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
