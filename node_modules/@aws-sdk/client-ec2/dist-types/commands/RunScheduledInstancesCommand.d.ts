...
declare const RunScheduledInstancesCommand_base: {
    new (input: RunScheduledInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<RunScheduledInstancesCommandInput, RunScheduledInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RunScheduledInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<RunScheduledInstancesCommandInput, RunScheduledInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
