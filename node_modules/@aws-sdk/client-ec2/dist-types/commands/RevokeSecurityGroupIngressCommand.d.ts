...
declare const RevokeSecurityGroupIngressCommand_base: {
    new (input: RevokeSecurityGroupIngressCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeSecurityGroupIngressCommandInput, RevokeSecurityGroupIngressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [RevokeSecurityGroupIngressCommandInput]): import("@smithy/smithy-client").CommandImpl<RevokeSecurityGroupIngressCommandInput, RevokeSecurityGroupIngressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
