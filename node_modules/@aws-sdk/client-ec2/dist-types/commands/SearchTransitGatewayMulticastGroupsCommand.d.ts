...
declare const SearchTransitGatewayMulticastGroupsCommand_base: {
    new (input: SearchTransitGatewayMulticastGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchTransitGatewayMulticastGroupsCommandInput, SearchTransitGatewayMulticastGroupsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SearchTransitGatewayMulticastGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchTransitGatewayMulticastGroupsCommandInput, SearchTransitGatewayMulticastGroupsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
