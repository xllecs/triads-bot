...
declare const DescribeIdFormatCommand_base: {
    new (input: DescribeIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeIdFormatCommandInput, DescribeIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeIdFormatCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeIdFormatCommandInput, DescribeIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
