...
declare const ModifyVerifiedAccessInstanceCommand_base: {
    new (input: ModifyVerifiedAccessInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyVerifiedAccessInstanceCommandInput, ModifyVerifiedAccessInstanceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyVerifiedAccessInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyVerifiedAccessInstanceCommandInput, ModifyVerifiedAccessInstanceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
