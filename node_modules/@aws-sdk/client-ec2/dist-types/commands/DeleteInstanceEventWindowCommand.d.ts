...
declare const DeleteInstanceEventWindowCommand_base: {
    new (input: DeleteInstanceEventWindowCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteInstanceEventWindowCommandInput, DeleteInstanceEventWindowCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteInstanceEventWindowCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteInstanceEventWindowCommandInput, DeleteInstanceEventWindowCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
