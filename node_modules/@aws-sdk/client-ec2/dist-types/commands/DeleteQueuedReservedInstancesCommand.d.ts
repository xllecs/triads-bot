...
declare const DeleteQueuedReservedInstancesCommand_base: {
    new (input: DeleteQueuedReservedInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteQueuedReservedInstancesCommandInput, DeleteQueuedReservedInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteQueuedReservedInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteQueuedReservedInstancesCommandInput, DeleteQueuedReservedInstancesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
