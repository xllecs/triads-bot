...
declare const DisableFastSnapshotRestoresCommand_base: {
    new (input: DisableFastSnapshotRestoresCommandInput): import("@smithy/smithy-client").CommandImpl<DisableFastSnapshotRestoresCommandInput, DisableFastSnapshotRestoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisableFastSnapshotRestoresCommandInput): import("@smithy/smithy-client").CommandImpl<DisableFastSnapshotRestoresCommandInput, DisableFastSnapshotRestoresCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
