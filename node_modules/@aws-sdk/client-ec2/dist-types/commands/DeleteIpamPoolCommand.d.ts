...
declare const DeleteIpamPoolCommand_base: {
    new (input: DeleteIpamPoolCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamPoolCommandInput, DeleteIpamPoolCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteIpamPoolCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamPoolCommandInput, DeleteIpamPoolCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
