...
declare const DeleteNetworkInsightsAnalysisCommand_base: {
    new (input: DeleteNetworkInsightsAnalysisCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteNetworkInsightsAnalysisCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteNetworkInsightsAnalysisCommandInput, DeleteNetworkInsightsAnalysisCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
