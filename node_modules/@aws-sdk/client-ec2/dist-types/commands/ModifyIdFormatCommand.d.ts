...
declare const ModifyIdFormatCommand_base: {
    new (input: ModifyIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIdFormatCommandInput, ModifyIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIdFormatCommandInput, ModifyIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
