...
declare const DisableTransitGatewayRouteTablePropagationCommand_base: {
    new (input: DisableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/smithy-client").CommandImpl<DisableTransitGatewayRouteTablePropagationCommandInput, DisableTransitGatewayRouteTablePropagationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisableTransitGatewayRouteTablePropagationCommandInput): import("@smithy/smithy-client").CommandImpl<DisableTransitGatewayRouteTablePropagationCommandInput, DisableTransitGatewayRouteTablePropagationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
