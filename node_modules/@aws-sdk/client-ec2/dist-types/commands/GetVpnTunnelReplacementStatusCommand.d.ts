...
declare const GetVpnTunnelReplacementStatusCommand_base: {
    new (input: GetVpnTunnelReplacementStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetVpnTunnelReplacementStatusCommandInput, GetVpnTunnelReplacementStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVpnTunnelReplacementStatusCommandInput): import("@smithy/smithy-client").CommandImpl<GetVpnTunnelReplacementStatusCommandInput, GetVpnTunnelReplacementStatusCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
