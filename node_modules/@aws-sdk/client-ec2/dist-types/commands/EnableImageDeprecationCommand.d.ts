...
declare const EnableImageDeprecationCommand_base: {
    new (input: EnableImageDeprecationCommandInput): import("@smithy/smithy-client").CommandImpl<EnableImageDeprecationCommandInput, EnableImageDeprecationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: EnableImageDeprecationCommandInput): import("@smithy/smithy-client").CommandImpl<EnableImageDeprecationCommandInput, EnableImageDeprecationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
