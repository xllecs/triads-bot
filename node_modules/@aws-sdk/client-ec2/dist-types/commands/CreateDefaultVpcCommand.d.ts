...
declare const CreateDefaultVpcCommand_base: {
    new (input: CreateDefaultVpcCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDefaultVpcCommandInput, CreateDefaultVpcCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [CreateDefaultVpcCommandInput]): import("@smithy/smithy-client").CommandImpl<CreateDefaultVpcCommandInput, CreateDefaultVpcCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
