...
declare const DeleteIpamResourceDiscoveryCommand_base: {
    new (input: DeleteIpamResourceDiscoveryCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamResourceDiscoveryCommandInput, DeleteIpamResourceDiscoveryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteIpamResourceDiscoveryCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamResourceDiscoveryCommandInput, DeleteIpamResourceDiscoveryCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
