...
declare const DescribeManagedPrefixListsCommand_base: {
    new (input: DescribeManagedPrefixListsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeManagedPrefixListsCommandInput, DescribeManagedPrefixListsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeManagedPrefixListsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeManagedPrefixListsCommandInput, DescribeManagedPrefixListsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
