...
declare const DeleteTrafficMirrorTargetCommand_base: {
    new (input: DeleteTrafficMirrorTargetCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTrafficMirrorTargetCommandInput, DeleteTrafficMirrorTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteTrafficMirrorTargetCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTrafficMirrorTargetCommandInput, DeleteTrafficMirrorTargetCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
