...
declare const DescribeIdentityIdFormatCommand_base: {
    new (input: DescribeIdentityIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeIdentityIdFormatCommandInput, DescribeIdentityIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeIdentityIdFormatCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeIdentityIdFormatCommandInput, DescribeIdentityIdFormatCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
