...
declare const RevokeSecurityGroupEgressCommand_base: {
    new (input: RevokeSecurityGroupEgressCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeSecurityGroupEgressCommandInput, RevokeSecurityGroupEgressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RevokeSecurityGroupEgressCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeSecurityGroupEgressCommandInput, RevokeSecurityGroupEgressCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
