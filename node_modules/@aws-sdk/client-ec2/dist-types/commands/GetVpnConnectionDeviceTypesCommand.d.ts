...
declare const GetVpnConnectionDeviceTypesCommand_base: {
    new (input: GetVpnConnectionDeviceTypesCommandInput): import("@smithy/smithy-client").CommandImpl<GetVpnConnectionDeviceTypesCommandInput, GetVpnConnectionDeviceTypesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetVpnConnectionDeviceTypesCommandInput]): import("@smithy/smithy-client").CommandImpl<GetVpnConnectionDeviceTypesCommandInput, GetVpnConnectionDeviceTypesCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
