...
declare const DescribeInstanceCreditSpecificationsCommand_base: {
    new (input: DescribeInstanceCreditSpecificationsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeInstanceCreditSpecificationsCommandInput, DescribeInstanceCreditSpecificationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeInstanceCreditSpecificationsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeInstanceCreditSpecificationsCommandInput, DescribeInstanceCreditSpecificationsCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
