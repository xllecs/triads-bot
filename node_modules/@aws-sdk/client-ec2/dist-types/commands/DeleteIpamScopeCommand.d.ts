...
declare const DeleteIpamScopeCommand_base: {
    new (input: DeleteIpamScopeCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamScopeCommandInput, DeleteIpamScopeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteIpamScopeCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteIpamScopeCommandInput, DeleteIpamScopeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
