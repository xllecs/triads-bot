...
declare const ModifyInstancePlacementCommand_base: {
    new (input: ModifyInstancePlacementCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyInstancePlacementCommandInput, ModifyInstancePlacementCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyInstancePlacementCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyInstancePlacementCommandInput, ModifyInstancePlacementCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
