...
declare const DescribeNetworkInterfaceAttributeCommand_base: {
    new (input: DescribeNetworkInterfaceAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeNetworkInterfaceAttributeCommandInput, DescribeNetworkInterfaceAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeNetworkInterfaceAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeNetworkInterfaceAttributeCommandInput, DescribeNetworkInterfaceAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
