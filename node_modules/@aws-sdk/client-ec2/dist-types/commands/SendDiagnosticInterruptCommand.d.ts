...
declare const SendDiagnosticInterruptCommand_base: {
    new (input: SendDiagnosticInterruptCommandInput): import("@smithy/smithy-client").CommandImpl<SendDiagnosticInterruptCommandInput, SendDiagnosticInterruptCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SendDiagnosticInterruptCommandInput): import("@smithy/smithy-client").CommandImpl<SendDiagnosticInterruptCommandInput, SendDiagnosticInterruptCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
