...
declare const DisassociateTrunkInterfaceCommand_base: {
    new (input: DisassociateTrunkInterfaceCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateTrunkInterfaceCommandInput, DisassociateTrunkInterfaceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateTrunkInterfaceCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateTrunkInterfaceCommandInput, DisassociateTrunkInterfaceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
