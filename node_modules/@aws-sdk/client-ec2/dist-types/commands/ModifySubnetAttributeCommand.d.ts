...
declare const ModifySubnetAttributeCommand_base: {
    new (input: ModifySubnetAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ModifySubnetAttributeCommandInput, ModifySubnetAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifySubnetAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ModifySubnetAttributeCommandInput, ModifySubnetAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
