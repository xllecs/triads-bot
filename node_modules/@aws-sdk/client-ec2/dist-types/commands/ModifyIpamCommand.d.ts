...
declare const ModifyIpamCommand_base: {
    new (input: ModifyIpamCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIpamCommandInput, ModifyIpamCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyIpamCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyIpamCommandInput, ModifyIpamCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
