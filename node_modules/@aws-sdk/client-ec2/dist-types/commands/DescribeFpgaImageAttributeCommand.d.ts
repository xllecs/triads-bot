...
declare const DescribeFpgaImageAttributeCommand_base: {
    new (input: DescribeFpgaImageAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFpgaImageAttributeCommandInput, DescribeFpgaImageAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeFpgaImageAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFpgaImageAttributeCommandInput, DescribeFpgaImageAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
