...
import { AcceptCapacityReservationBillingOwnershipRequest, AcceptCapacityReservationBillingOwnershipResult } from "../models/models_0";
/**
 * @public
 */
...
declare const AcceptCapacityReservationBillingOwnershipCommand_base: {
    new (input: AcceptCapacityReservationBillingOwnershipCommandInput): import("@smithy/smithy-client").CommandImpl<AcceptCapacityReservationBillingOwnershipCommandInput, AcceptCapacityReservationBillingOwnershipCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AcceptCapacityReservationBillingOwnershipCommandInput): import("@smithy/smithy-client").CommandImpl<AcceptCapacityReservationBillingOwnershipCommandInput, AcceptCapacityReservationBillingOwnershipCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
