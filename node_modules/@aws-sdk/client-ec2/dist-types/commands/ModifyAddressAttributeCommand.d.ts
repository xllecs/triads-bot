...
declare const ModifyAddressAttributeCommand_base: {
    new (input: ModifyAddressAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyAddressAttributeCommandInput, ModifyAddressAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyAddressAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyAddressAttributeCommandInput, ModifyAddressAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
