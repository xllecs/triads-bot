...
declare const BundleInstanceCommand_base: {
    new (input: BundleInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<BundleInstanceCommandInput, BundleInstanceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BundleInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<BundleInstanceCommandInput, BundleInstanceCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
