...
declare const DeleteTransitGatewayRouteCommand_base: {
    new (input: DeleteTransitGatewayRouteCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransitGatewayRouteCommandInput, DeleteTransitGatewayRouteCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteTransitGatewayRouteCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteTransitGatewayRouteCommandInput, DeleteTransitGatewayRouteCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
