...
declare const ModifyFpgaImageAttributeCommand_base: {
    new (input: ModifyFpgaImageAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyFpgaImageAttributeCommandInput, ModifyFpgaImageAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyFpgaImageAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyFpgaImageAttributeCommandInput, ModifyFpgaImageAttributeCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
