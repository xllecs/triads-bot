...
declare const ModifyVerifiedAccessInstanceLoggingConfigurationCommand_base: {
    new (input: ModifyVerifiedAccessInstanceLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyVerifiedAccessInstanceLoggingConfigurationCommandInput, ModifyVerifiedAccessInstanceLoggingConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyVerifiedAccessInstanceLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyVerifiedAccessInstanceLoggingConfigurationCommandInput, ModifyVerifiedAccessInstanceLoggingConfigurationCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
